...
La idea es construir una aplicación a partir de funciones elementales que se usan como piezas para ir armando componentes más complejos. El libro ofrece una receta para desarrollar una función, que es la unidad mínima de código recomendada. Vamos a elaborar cada una de las funciones de nuestra aplicación de acuerdo a los pasos de la siguiente receta:
