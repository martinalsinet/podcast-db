...
En este caso, vamos a desarrollar nuestra aplicación usando [[https://python.org][Python]] bajo el paradigma de programación funcional. Esto quiere decir que nuestra aplicación va a estar mayormente compuesta de funciones (=def my_func():=) que vamos a combinar para realizar tareas complejas.
...
Este implementa las siguentes funcionalidades:
