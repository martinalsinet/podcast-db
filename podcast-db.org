...
def title_from_tag(tag):
    ...
    title = ""
    cls = "replay-button"
    button = tag.find("button", class_=cls)
    if button and "data-diffusion-title" in button.attrs:
        title = button.attrs["data-diffusion-title"]
    return title
...
- Caso exitoso, Un tag que contiene un =<button>= con la clase =replay-button= y un URL el atributo =data-url=
- Un tag que no tiene el =<button>=
- Un tag que tiene el =<button>= pero éste no tiene la clase =replay-button=
...
- Caso exitoso, Un tag que contiene un =<button>= con la clase =replay-button= y una fecha en el atributo =data-diffusion-path=
- Un tag que no tiene el =<button>=
- Un tag que tiene el =<button>= pero éste no tiene la clase =replay-button=
- Un tag que tiene el =<button>= pero éste no tiene el atributo =data-diffusion-path=
...
def tag_with_date():
    html = '''<div>
<p>Lorem ipsum</p>
<button class="replay-button" data-diffusion-path="/emissions/sur-les-epaules-de-darwin/sur-les-epaules-de-darwin-26-janvier-2019">
</button>
    </div>'''
    soup = BeautifulSoup(html, "html.parser")
    tag = soup.div
...
def tag_without_class():
    html = '''<div>
<p>Lorem ipsum</p>
<button data-diffusion-path="/emissions/sur-les-epaules-de-darwin/sur-les-epaules-de-darwin-26-janvier-2019">
</button>
    </div>'''
    soup = BeautifulSoup(html, "html.parser")
    tag = soup.div
...
def tag_without_button():
    html = '''<div>
<p>Lorem ipsum</p>
<a class="replay-button" data-diffusion-path="/emissions/sur-les-epaules-de-darwin/sur-les-epaules-de-darwin-26-janvier-2019">
</a>
    </div>'''
    soup = BeautifulSoup(html, "html.parser")
    tag = soup.div
...
def tag_with_invalid_month():
    html = '''<div>
<p>Lorem ipsum</p>
<button class="replay-button" data-diffusion-path="/emissions/sur-les-epaules-de-darwin/sur-les-epaules-de-darwin-26-january-2019">
</button>
    </div>'''
    soup = BeautifulSoup(html, "html.parser")
    tag = soup.div
...
def tag_with_invalid_day():
    html = '''<div>
<p>Lorem ipsum</p>
<button class="replay-button" data-diffusion-path="/emissions/sur-les-epaules-de-darwin/sur-les-epaules-de-darwin-42-janvier-2019">
</button>
    </div>'''
    soup = BeautifulSoup(html, "html.parser")
    tag = soup.div
...
def date_from_tag(tag):
    ...
    date = ""
    # hay que buscar un <button> con la clase "replay-button"
    # si existe el <button> hay que revisar si tiene el atributo "data-diffusion-tag"
    # si tiene el atributo se guarda en la variable attr
...
def date_from_tag(tag):
    ...
    cls = "replay-button"
    button = tag.find("button", class_=cls)
    if button and "data-diffusion-path" in button.attrs:
        attr = button.attrs["data-diffusion-path"]
...
- Caso exitoso, devuelve la fecha
- Cuando recibe un tag que no es un bs4.element.tag, lanza un =AssertionError=
- Cuando recibe un tag que no contiene un =<button>=, devuelve un string vacío
- Cuando recibe un tag que tiene el =<button>= pero éste no tiene la clase correcta, devuelve un string vacío
- Cuando recibe un tag que tiene el =<button>= con la clase correcta, pero éste no tiene el atributo =data-diffusion-path=, devuelve un string vacío
- Cuando recibe un tag que tiene el =<button>= con la clase correcta, pero éste no tiene una fecha válida en el atributo =data-diffusion-path=, lanza un =AssertionError=
...
- Caso exitoso, un tag que contiene un =<button>= con la clase =replay-button= y una duración en el atributo =data-duration-seconds=
- Un tag que no tiene el =<button>=
- Un tag que tiene el =<button>= pero éste no tiene la clase =replay-button=
- Un tag que tiene el =<button>= pero éste no tiene el atributo =data-url=
- Un tag que contiene un =<button>= con la clase =replay-button= pero que no contiene un número entero en el atributo =data-duration-seconds=
...
def tag_with_duration():
    html = '''<div>
<p>Lorem ipsum</p>
<button class="replay-button" data-duration-seconds="3256">
</button>
    </div>'''
    soup = BeautifulSoup(html, "html.parser")
    tag = soup.div
...
def tag_without_class():
    html = '''<div>
<p>Lorem ipsum</p>
<button data-duration-seconds="3256">
</button>
    </div>'''
    soup = BeautifulSoup(html, "html.parser")
    tag = soup.div
...
def tag_without_button():
    html = '''<div>
<p>Lorem ipsum</p>
<p class="replay-button" data-duration-seconds="3256">
</p>
    </div>'''
    soup = BeautifulSoup(html, "html.parser")
    tag = soup.div
...
def tag_with_invalid_duration():
    html = '''<div>
<p>Lorem ipsum</p>
<button class="replay-button" data-duration-seconds="six seconds">
</button>
    </div>'''
    soup = BeautifulSoup(html, "html.parser")
    tag = soup.div
...
def duration_from_tag(tag):
    ...
    duration = ""
    # hay que buscar un <button> con la clase "replay-button"
    # si existe el <button> hay que revisar si tiene el atributo "data-duration-seconds"
    # si tiene el atributo se guarda en la variable duration
...
def duration_from_tag(tag):
    ...
    cls = "replay-button"
    button = tag.find("button", class_=cls)
    if button and "data-duration-seconds" in button.attrs:
        value = button.attrs["data-duration-seconds"]
        try:
            duration = int(value)
        except ValueError:
...
- Caso exitoso, devuelve el título
- Cuando recibe un tag que no es un bs4.element.tag, lanza un =AssertionError=
- Cuando recibe un tag que no contiene un =<button>=, devuelve =0=
- Cuando recibe un tag que tiene el =<button>= pero éste no tiene la clase correcta, devuelve =0=
- Cuando recibe un tag que tiene el =<button>= con la clase correcta, pero éste no tiene el atributo =data-url=, devuelve =0=
- Cuando recibe un tag que contiene un =<button>= con la clase =replay-button= pero que no contiene un número entero en el atributo =data-duration-seconds=, lanza un =AssertionError=
...
class Episode:
    ...
    def __repr__(self):
        return "Episode(title='%s', url='%s')" % (self.title, self.url)
...
def tag_ok():
    html = '''<div class="media-visual-replay-button"><button class="replay-button
                 playable"
...
def no_title(tag):
    return "received tag does not have a episode title\n %s" % str(tag)
...
A primera vista, parecería ser una función trivial que quizás no debiera existir. Sin embargo, al encapsular las peticiones HTTP en esta función ganamos la posibilidad de cambiar la dependencia de la biblioteca =requests= en caso que sea necesario.

Por ahora colocamos esta función en el módulo episodes, pero la idea es extraerla en un nuevo módulo =HTML= dentro de =Utils= para poder utilizarla en otras partes de la aplicación. Podremos utilizarla, por ejemplo, en la función =podcasts_from_url=.
...
def div(content, class_name=""):
    attr = ""
    if class_name:
        attr = 'class="%s"' % class_name
    html = '''<div %s>%s</div>''' % (attr, content)
    soup = BeautifulSoup(html, "html.parser")
    return soup.div
