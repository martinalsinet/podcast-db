...
*** Build CLI Standalone Executable
...
- [ ] Filtrar el listado por año
- [ ] Filtrar el listado por mes
- [ ] Buscar un episodio por su fecha de emisión
...
- Cuando recibe un año que que es negativo, devuelve un =filter= vacío
