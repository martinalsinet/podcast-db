...
<p>Lorem ipsum</p>
<span class="rich-section-list-item-content-title">
<p href="emissions/la-tete-au-carre"></p>
</span>
    /div>'''
    soup = BeautifulSoup(html, "html.parser")
    tag = soup.div
...
<p>Lorem ipsum</p>
<span class="rich-section-list-item-content-title">
<a src="emissions/la-tete-au-carre"></a>
</span>
    /div>'''
    soup = BeautifulSoup(html, "html.parser")
    tag = soup.div
...
5. El html tiene el =span= y el =a= pero éste último no tiene el atributo =href=, devuelve un string vacío

#+begin_src python :tangle franceinter/podcasts/tests/test_url_from_tag.py
from bs4 import BeautifulSoup
from franceinter.podcasts.url_from_tag import *
from franceinter.podcasts.tests.examples_url_from_tag import *
